...
**** TODO <2016-06-27 周一> [0%]
***** TODO 登录器优化 [0%]
	  * [ ] 登录器的安装包必须有某种关联对应剩余补丁包的机制
	  * [ ] 下载完游戏基本组件进入游戏，登录器停止下载，只下载微端资源
	  * [ ] 微端代理进程不下载非当前必要资源
	  * [ ] 下载器进度条去掉多余显示（下载点1/1）
	  * [ ] 游戏首次安装过程中去掉新闻弹框
***** TODO 登录器非法检查
***** TODO 多国国战竞猜(许天明) [代码Review]
...
**** TODO <2016-06-27 周一> [%]
***** TODO [[http://linux.vbird.org/linux_basic/#part1][第一部份 Linux 的规划与安装]] [40%]
	  * [X] Linux是什么
	  * [X] Linux如何学习
	  * [ ] 主机规划与磁盘分区
	  * [ ] 安装CentOS 5.x与多重引导技巧

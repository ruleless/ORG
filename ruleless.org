...
***** DONE 龙舟地图载具抖动问题
	  ...
	  - State "DONE"       from "TODO"       [2016-06-06 周一 09:53]
**** TODO <2016-06-06 周一> [%]
**** TODO 制作10M(或以下)登录器，游戏客户端所含文件在玩家第一次运行登录器后再开始下载。
...
**** TODO <2016-06-06 周一> [0%]
***** TODO AsyncNet 库中 AsyncCore 设计
***** TODO AsyncNet 中的数据结构
	  + [ ] IVECTOR
	  + [ ] IMEMNODE
	  + [ ] IQUEUE
***** TODO md文档：Unix 编程环境下的线程知识
***** TODO md文档：Unix 编程环境下的 I/O
***** TODO md文档：Unix 编程环境下的进程IPC
